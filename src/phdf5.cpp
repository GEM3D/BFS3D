...
void Phdf5::xdmfMultiBlock( ChunkedArray &F, integer comsize, integer my_rank, uint offset, uint appx, const char* XDMF_NAME )
{
    MPI_File     fp;
    ...
    int len=strlen(XDMF_NAME)-2-5; 
  //  char *fname=new char[len];
    
    for(int k=0;k<len-2;k++)    
        fname[k]=XDMF_NAME[k+5];
...
#if ( DEBUG )
void Phdf5::writeMultiBlockCellCenter( ChunkedArray &F, uint appx, const char* H5FILE_NAME )
{
...
void Phdf5::writeMultiBlockCellCenter( ChunkedArray &F, uint appx, int dir, int aligndir, const char* H5FILE_NAME, const char* XDMF_NAME )
{
    hid_t   file_id, dset_id;    /* file and dataset identifiers */
    hid_t   filespace, memspace; /* file and memory dataspace identifiers */
    hsize_t dimsf[4];            /* dataset dimensions */
    ...
    */
    ...
    // xdmfMultiBlock(F, com.mySize() ,com.myRank(), offset1,appx );
    xdmfMultiBlockCellCenter( F, com.mySize(), com.myRank(), offset1, appx, XDMF_NAME );
...
void Phdf5::xdmfMultiBlockCellCenter( ChunkedArray &F, integer comsize, integer my_rank, uint offset, uint appx, const char *XDMF_NAME )
{
    MPI_File     fp;
    int          buf[1000], np = comsize;
    MPI_Request  request;
